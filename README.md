...
2. **Agent 2: Documentation Agent**
   * Utilizes the constrained prompt from Phase 1 and passes it to the **Gemini 3 Flash LLM**.
   * Generates highly-accurate, markdown-formatted technical documentation.
3. **Agent 3: Verification Gatekeeper**
   * Takes the final markdown generated by Phase 2 and extracts any raw code blocks.
